...
public:
  ...
  /*This is a copy constructor if A = NUM_TYPE.
  * Otherwise it defines an explicit conversion the vector to the appropriate type using standard arithmetic conversions*/
