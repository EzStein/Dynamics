#include "level_addition_operator_visitor.h"
...
#include "compiler/ast/variable_leaf_node.h"
  ...
  */
 void level_addition_operator_visitor::visit(polyadic_addition_operator_node* node) {
  ...
  */
 void level_addition_operator_visitor::visit(polyadic_multiplication_operator_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(binary_subtraction_operator_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(division_operator_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(exponentiation_operator_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(binary_addition_operator_node* node) {
 ...
 void level_addition_operator_visitor::visit(unary_minus_operator_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(integer_number_leaf_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(number_leaf_node* node) {
   newChildren.push_back(node);
 }

 void level_addition_operator_visitor::visit(variable_leaf_node* node) {
   newChildren.push_back(node);
 }
