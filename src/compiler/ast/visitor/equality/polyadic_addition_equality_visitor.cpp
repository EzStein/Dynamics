 ...
 */
#include "polyadic_addition_equality_visitor.h"
#include "compiler/ast/polyadic_operator_node.h"

polyadic_addition_equality_visitor::polyadic_addition_equality_visitor(
polyadic_addition_operator_node* node1,bool& retVal) : cascaded_equality_base_visitor(retVal), node1(node1){

}


void polyadic_addition_equality_visitor::visit(polyadic_addition_operator_node* node2) {
