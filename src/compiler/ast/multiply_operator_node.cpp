...
std::ostream& multiply_operator_node::emit_code_ia32(std::ostream& acc, compiler_data& data) const {
...
std::ostream& multiply_operator_node::emit_code_amd64(std::ostream& acc, compiler_data& data) const {
...
expression_node* multiply_operator_node::copy() const {
  return AST::make_binary_operator_node<multiply_operator_node>(leftChild->copy(), rightChild->copy());
}
