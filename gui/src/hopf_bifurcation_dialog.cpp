...
hopf_bifurcation_dialog::hopf_bifurcation_dialog(const app& appl)
  : hopf_bifurcation_dialog_base(nullptr), appl(appl) {
...
bool hopf_bifurcation_dialog::show_dialog(hopf_bifurcation_specs& newSpecs) {
  specs = newSpecs;
  set_ui();
...
void hopf_bifurcation_dialog::set_ui() {
...
bool hopf_bifurcation_dialog::validate_and_set() {
...
void hopf_bifurcation_dialog::cancel_button_on_button_click(wxCommandEvent& evt) {
  EndModal(wxID_CANCEL);
}

void hopf_bifurcation_dialog::ok_button_on_button_click(wxCommandEvent& evt) {
  if(validate_and_set()) {
    EndModal(wxID_OK);
  }
}
